...
@section('coach-content')
    <div class="vstack gap-4">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ secure_route('coach.courses.manage', $lesson->course) }}" class="btn btn-sm btn-outline-secondary">
                ← Back to Course
            </a>
        </div>
                        ...
                        <tbody>
                            @foreach($lesson->submissions as $index => $submission)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ secure_route('coach.submissions.grade', $submission) }}" class="d-flex align-items-center">
                                            @csrf
                                            @method('PUT')
        ...
        <section>
            @if(Route::has('coach.lessons.edit'))
                <a href="{{ secure_route('coach.lessons.edit', $lesson) }}" class="btn btn-primary">
                    Edit Lesson
                </a>
            @endif
        </section>
