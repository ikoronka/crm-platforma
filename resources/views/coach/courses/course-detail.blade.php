    ...
    <div class="space-y-8">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ secure_url('coach.lessons.create', $course) }}" class="btn btn-sm btn-primary">Create Lesson</a>
                <a href="{{ secure_url('coach.dashboard') }}" class="btn btn-sm btn-outline">
                    ← Back to Dashboard
                </a>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="{{ secure_url('coach.lessons.lesson-detail', $lesson) }}" class="btn btn-sm btn-outline">View</a>
                                    @if(Route::has('coach.lessons.edit'))
                                        <a href="{{ secure_url('coach.lessons.edit', $lesson) }}" class="btn btn-sm">Edit</a>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <section>
            <a href="{{ secure_url('coach.courses.edit', $course) }}" class="btn btn-primary">
                Edit Course
            </a>
        </section>
