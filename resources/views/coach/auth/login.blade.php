...
<div class="d-flex align-items-center justify-content-center" style="min-height: 80vh;">
   <form method="POST" action="{{ secure_url('coach.login') }}" class="border rounded p-4 shadow w-100" style="max-width: 400px;">
        @csrf
       ...
       <label for="password">Password</label>
        ...
        <p class="text-center mt-3 small">
            Student? <a href="{{ secure_url('student.login.show') }}">Login here</a>
        </p>
   </form>
</div>
@endsection
